...
const NAMESPACE = 'wl-range';
const BUILD = /* wl-range */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: true, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: true, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: true, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: false, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: true };
...
var appGlobalScript = () => {
  ...
  WL.config = config;
  WL.mode = defaultMode = config.get('mode', doc.documentElement.getAttribute('mode') || (isPlatform(win, 'ios') ? 'ios' : 'md'));
...
const createTime = (e, t = "") => {
 ...
 const t = e.$cmpMeta$, o = e.$hostElement$, n = t.$flags$, s = createTime("attachStyles", t.$tagName$), a = addStyle( o.getRootNode(), t, e.$modeName$);
  10 & n && (o["s-sc"] = a, 
 o.classList.add(a + "-h"), BUILD.scoped  ), 
 s();
 ...
 if (d(o), t && (BUILD.vdomClass)) {
  const e = t.className || t.class;
  e && (t.class = "object" != typeof e ? e : Object.keys(e).filter(t => e[t]).join(" "));
 }
 const c = newVNode(e, null);
 return c.$attrs$ = t, i.length > 0 && (c.$children$ = i), c;
}, newVNode = (e, t) => {
 const o = {
  $flags$: 0,
  $tag$: e,
 ...
 return  (o.$attrs$ = null), o;
}, Host = {}, isHost = e => e && e.$tag$ === Host, setAccessor = (e, t, o, n, s, a) => {
 if (o !== n) {
  ...
  } else if ( "ref" === t) n && n(e); else if ( ( l ) || "o" !== t[0] || "n" !== t[1]) {
   {
    ...
    null == n || !1 === n ? !1 === n && "" !== e.getAttribute(t) || ( e.removeAttribute(t)) : (!l || 4 & a || s) && !i && (n = !0 === n ? "" : n, 
     e.setAttribute(t, n));
   }
...
let scopeId, hostTagName, isSvgMode = !1;

const createElm = (e, t, o, n) => {
 let s, a, r = t.$children$[o], i = 0;
 if ( null !== r.$text$) s = r.$elm$ = doc.createTextNode(r.$text$); else {
  if (s = r.$elm$ =  doc.createElement( r.$tag$), 
   updateElement(null, r, isSvgMode), 
   null != scopeId && s["s-si"] !== scopeId && s.classList.add(s["s-si"] = scopeId), 
  r.$children$) for (i = 0; i < r.$children$.length; ++i) a = createElm(e, r, i), 
  a && s.appendChild(a);
 }
 return s;
}, addVnodes = (e, t, o, n, s, a) => {
 let l, r =  e;
 for ( r.shadowRoot && r.tagName === hostTagName && (r = r.shadowRoot); s <= a; ++s) n[s] && (l = createElm(null, o, s), 
 l && (n[s].$elm$ = l, r.insertBefore(l,  t)));
}, removeVnodes = (e, t, o, n, s) => {
 for (;t <= o; ++t) (n = e[t]) && (s = n.$elm$, callNodeRefs(n), s.remove());
}, isSameVnode = (e, t) => e.$tag$ === t.$tag$ && ( !BUILD.vdomKey ), patch = (e, t) => {
 const o = t.$elm$ = e.$elm$, n = e.$children$, s = t.$children$, a = t.$tag$, l = t.$text$;
  null !== l ?   e.$text$ !== l && (o.data = l) : ( ( "slot" === a || updateElement(e, t, isSvgMode)), 
  null !== n && null !== s ? ((e, t, o, n) => {
  let s, l = 0, r = 0, c = t.length - 1, $ = t[0], m = t[c], p = n.length - 1, h = n[0], u = n[p];
  for (;l <= c && r <= p; ) if (null == $) $ = t[++l]; else if (null == m) m = t[--c]; else if (null == h) h = n[++r]; else if (null == u) u = n[--p]; else if (isSameVnode($, h)) patch($, h), 
  $ = t[++l], h = n[++r]; else if (isSameVnode(m, u)) patch(m, u), m = t[--c], u = n[--p]; else if (isSameVnode($, u)) patch($, u), e.insertBefore($.$elm$, m.$elm$.nextSibling), $ = t[++l], u = n[--p]; else if (isSameVnode(m, h)) patch(m, h), e.insertBefore(m.$elm$, $.$elm$), m = t[--c], h = n[++r]; else {
    (s = createElm(t && t[r], o, r), h = n[++r]), 
   s && ( $.$elm$.parentNode.insertBefore(s, $.$elm$));
  }
 ...
 const o = e.$hostElement$, s = e.$vnode$ || newVNode(null, null), a = isHost(t) ? t : h(null, null, t);
 if (hostTagName = o.tagName, BUILD.isDev  ) ;
 if (a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = s.$elm$ =  o.shadowRoot || o, 
  (scopeId = o["s-sc"]), patch(s, a), 
 BUILD.slotRelocation) ;
}, getElement = e =>  getHostRef(e).$hostElement$ , createEvent = (e, t, o) => {
 ...
 let a;
 return n(), then(a, () => updateComponent(e, s, t));
...
const callRender = (e, t) => {
 ...
 BUILD.isDev ), n(),  (e.$onReadyResolve$(o), a || appDidLoad())),  (e.$onRenderResolve$ && (e.$onRenderResolve$(), 
 ...
 e.$children$[d.$index$] = d) : "r" === r && ( n ? a.remove() : BUILD.slotRelocation ))); else if (e && "style" === e.$tag$) {
