...
class GestureDelegate {
  ...
  constructor(ctrl: GestureController, private id: number, private name: string, priority: number, private disableScroll: boolean) {
...
class BlockerDelegate {
  ...
  constructor(ctrl: GestureController, private id: number, private disable: string[] | undefined, private disableScroll: boolean) {
    this.ctrl = ctrl;
  }
